...
<html>
	<head>
		<meta charset="UTF-8">
		<title>자바빈 액션 태그 예제</title>
	</head>
	<body>
		<form name="frmLogin" method="post" action="newStudentOk2.jsp" >
		<table>
		     ...
		     <tr><td>학년:</td><td><input type="radio" name="stdYear" value="1">1학년
		    ...
		    <tr><td colspan="2"><input type="submit" value="로그인">  <input type="reset" value="다시입력"></td></tr>
	    </table>
	  </form>
	</body>
</html>